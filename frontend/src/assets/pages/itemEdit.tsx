        ...
        <div className="basis-full flex items-center justify-center">
            ...
            <div className=" flex flex-col bg-white h-fit w-200 space-y-20 p-10">
                ...
                <div className="space-y-4">
                    <NavLink to={""} className="h-20 rounded-3xl font-medium cursor-pointer flex items-center justify-center bg-blue-300 text-white transition duration-300 hover:scale-105" >
                        AGREGAR AL CARRITO
                    </NavLink>
