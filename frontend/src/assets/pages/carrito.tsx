...
const CarritoPage = () =>{
    ...
    const realizeBuy=()=>{
        ...
        fetch("http://localhost:8000/users/realizeABuy/1",{
            method:"PUT",
        ...
        return(
            <div className="h-full flex items-center p-10">
                ...
                <div className="w-150  bg-white fixed right-30 top-30 flex flex-col p-5 text-[20px] items-center space-y-10 rounded-2xl shadow ">
                    ...
                    <NavLink to={"/compraRealizadaPage"} className="bg-blue-300 w-full flex justify-center rounded-[10px] p-5 font-medium transition duration-300 hover:scale-105 hover:bg-blue-400" onClick={realizeBuy}>
                        REALIZAR LA COMPRA
                    </NavLink>
